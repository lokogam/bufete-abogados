...
return [
    ...
    'description' => 'API REST del sistema del bufete de abogados: autenticación con tokens Bearer (Laravel Sanctum) y operaciones CRUD sobre clientes, abogados y casos.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
            API REST protegida con tokens **Bearer**. Para consumir los endpoints protegidos:
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtén tu token con `POST /api/login` o `POST /api/register` y envíalo en el encabezado `Authorization: Bearer {token}`.',
    ],
